 ...
 */
export async function deck54Flow ({ runCase }: ModuleTools): Promise<void> {
	/* ─── Startup invariants ─────────────────────────────────────────────────── */
	...
	await runCase('Joker steal: victim receives a notification', async () => {
		...
		// Bob is the victim and must receive a mailing line
	...
	/* ─── Regular cards still work in a 54-deck game ─────────────────────────── */
	...
	/* ─── Joker in game start info message ────────────────────────────────────── */
	...
	/* ─── Bystander notification for joker steal ─────────────────────────────── */
